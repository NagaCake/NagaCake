...
// NagaCake (NCAKE) Is The Main Currency Of NagaCake Organization.
// NagaCake Contract Charges Total 6% Fess Per Transaction Which Is Divided Into 2 Parts -
// → 3% Redistributed Among Holders
// → 3% Goes For Marketing/Development/Team

// SPDX-License-Identifier: MIT
// Telegram  : https://t.me/nagacake
// Twitter   : https://twitter.com/naga_cake
// Website   : https://nagacake.org/
// Swap      : https://nagacakeswap.finance/
...
contract NagaCake is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**6 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tfundTotal;

    string private _name = "Naga Cake";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**7;
    uint256 private minimumTokensBeforeSwap = 5000 * 10**6 * 10**7; 
    
    address payable private fundAddress = 0x4b23a4d355a06179Be46d4322feB956BCaE97A61; //Goes To The Address For Marketing/Development/Team Help
    ...
    function totalfundBNB() private view returns (uint256) {
        // BNB has  18 decimals!
        return _tfundTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tfundTotal = _tfundTotal.add(address(this).balance);
        TransferfundETH(fundAddress, address(this).balance);
    }
    ...
    function removeAllFee() private {
        if(_HolderFee == 0 && _burnFee == 0 && _fundFee == 0) return;
    ...
    function setHolderFeePercent(uint256 HolderFee) private onlyOwner() {
    ...
    function setfundFeePercent(uint256 fundFee) private onlyOwner() {
        _fundFee = fundFee;
    }
    ...
    function TransferfundETH(address payable recipient, uint256 amount) private {
